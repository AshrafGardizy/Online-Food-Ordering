...
// Select Orders
$query_sel_orders = "SELECT * FROM ordered WHERE cust_id=:cust_id";
$orders_stmt = $pdo->prepare($query_sel_orders);
$orders_stmt->execute(["cust_id"=>$_SESSION["logged_in"]]);
$orders_num = $orders_stmt->rowCount();
...
<div class="about" id="about">
	<div class="container">
		<div class="heading">
			<h3 data-aos="zoom-in">My Orders</h3>
		</div>
		<div class="row foods_category">
			<div data-aos="zoom-in" class="col-md-12">
				<div class="panel panel-default">
					<div class="panel-heading text-center">Orders Table</div>
						...
						<div class="table-responsive">
                            <table class="table table-striped table-bordered table-hover">
								...
								<?php $x = 1; foreach ($order_rows as $order_row) { ?>
									...
									$sel_food_stmt->execute(["food_id"=>$order_row->food_id]);
									$food_row = $sel_food_stmt->fetch();
									// Food Category
									...
									<tr>
										...
										<td>
											<img src="<?= $food_row->photo; ?>" class="img-responsive" style="width:60px;"/>
										</td>
										<td>
											<?= $food_row->title; ?>
										</td>
