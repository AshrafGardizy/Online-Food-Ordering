...
// Update Admin
if (isset($_POST["update_staff_form"])) {
    ...
    $query = "UPDATE admin SET firstname=:firstname, lastname=:lastname, phone=:phone, email=:email, password=:password WHERE id=:id";
...
// Select Admin
$query_sel_staff = "SELECT * FROM admin WHERE id=:id";
$sel_staff_prepare = $pdo->prepare($query_sel_staff);
$sel_staff_prepare->execute(["id"=>$_GET["id"]]);
$staff_num = $sel_staff_prepare->rowCount();
$staff_row = $sel_staff_prepare->fetch();
                            ...
                            <div class="panel-body">
                                ...
                                <form method="post" enctype="multipart/form-data">
                                  <div class="form-group">
                                    <input type="text" class="form-control" value="<?= $staff_row->firstname; ?>" name="firstname" placeholder="Enter Firstname" required="">
                                  </div>
                                  <div class="form-group">
                                    <input type="text" class="form-control" value="<?= $staff_row->lastname; ?>" name="lastname" placeholder="Enter Lastname" required="">
                                  </div>
                                  <div class="form-group">
                                    <input type="text" class="form-control" value="<?= $staff_row->phone; ?>" name="phone_no" placeholder="Enter Phone No" required="">
                                  </div>
                                  <div class="form-group">
                                    <input type="text" class="form-control" value="<?= $staff_row->email; ?>" name="email" placeholder="Enter Email" required="">
                                  </div>
                                  <div class="form-group">
                                    <input type="password" class="form-control" name="password" placeholder="Enter Password" required="">
                                  </div>

                                  <button type="submit" class="btn btn-success" name="update_staff_form">Save Changes</button>
                                </form>
